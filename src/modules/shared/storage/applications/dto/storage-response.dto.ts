...
export class StorageResponseDto {
  @ApiProperty({
    description:
      'UUID record StoredFile di database. Digunakan secara internal — tidak perlu dikirim ulang ke /predictions karena flow sudah terintegrasi.',
  ...
  @ApiProperty({ example: 'example-photo.jpg' })
  originalName: string = '';
